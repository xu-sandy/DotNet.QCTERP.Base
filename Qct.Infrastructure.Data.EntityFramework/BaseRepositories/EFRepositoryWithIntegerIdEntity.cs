...
{
    public class EFRepositoryWithIntegerIdEntity<T> : IEFRepository<T>
         where T : class, IntegerIdEntity,new()
    {
        ...
        public EFRepositoryWithIntegerIdEntity(CommonDbContext dataContext)
        {
